...
- **GenAI tutorial**: See the new GenAI workflow vignette
  (`vignettes/genai-tutorial.Rmd`) or the pkgdown Articles → “GenAI
  workflow” page for prompts, tooling, and lessons learned.
